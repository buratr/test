<script lang="ts">
import { cartItems, removeFromCart, getTotalOrderAmount } from '$lib/store';
...
<div on:click={hiddenCart} class="absolute left-0 right-0 top-0 bottom-0 bg-[#00000033]"></div>
    ...
    <div class="mt-auto pt-2">
        ...
        <div class="flex items-center justify-between px-7 mb-6">
            <div class="font-['Poppins'] text-base font-normal text-[#000000]">Subtotal</div>
            <div class="font-['Poppins'] text-base font-semibold text-[#B88E2F] mx-auto">Rs. {totalAmount||0}</div>
        </div>
        <hr>
