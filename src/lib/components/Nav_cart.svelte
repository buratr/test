...
<div on:click={hiddenCart} class="absolute left-0 right-0 top-0 bottom-0 bg-[#00000033]"></div>
    ...
    <div class="mt-auto pt-2">
        ...
        <div class="flex items-center justify-between px-7 mb-6">
            ...
            <div class="font-['Poppins'] text-base font-semibold text-[#B88E2F] mx-auto">Rs. 520,000.00</div>
        </div>
        <hr>
        <div class="px-7 font-['Poppins'] text-xs mt-7 grid grid-cols-3 gap-x-3.5">
            <div class="cursor-pointer border border-black rounded-[50px] px-7 py-2 flex justify-center items-center hover:bg-black hover:text-white">Cart</div>
