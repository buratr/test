...
<section class="flex bg-cover justify-center bg-center relative">
	...
	<div class="container z-10">
		<div class="flex justify-center py-36">
			<div class=" ">
				<div class="font-['Poppins'] text-5xl font-medium text-[#000000] ">Contact</div>
				<div class="flex justify-center mt-3">
					...
					<div class="font-['Poppins'] text-base font-medium text-[#000000]">Contact</div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="flex flex-col">
			<div class="w-2/3 text-center mx-auto">
				<div class="font-['Poppins'] text-4xl font-semibold text-[#000000]">Get In Touch With Us</div>
				<div class="mt-3 font-['Poppins'] text-base font-normal text-[#9F9F9F]">
					For More Information About Our Product & Services. Please Feel Free To Drop Us An Email. Our Staff Always Be There To Help You Out. Do Not Hesitate!
				</div>
			</div>

			<div class="mt-36 flex flex-row ">
				<!-- info wrap -->
				<div>
					<!-- info item -->
					<div class="w-80 flex mb-10">
						<svg class="w-8" width="22" height="28" viewBox="0 0 22 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11 0.120083C8.08369 0.123473 5.28779 1.26659 3.22564 3.29867C1.16348 5.33075 0.00345217 8.08587 1.17029e-05 10.9597C-0.00348119 13.3081 0.774992 15.5929 2.21601 17.4634C2.21601 17.4634 2.51601 17.8527 2.56501 17.9088L11 27.7118L19.439 17.9039C19.483 17.8517 19.784 17.4634 19.784 17.4634L19.785 17.4605C21.2253 15.5907 22.0034 13.3071 22 10.9597C21.9966 8.08587 20.8365 5.33075 18.7744 3.29867C16.7122 1.26659 13.9163 0.123473 11 0.120083ZM11 14.9013C10.2089 14.9013 9.43553 14.6702 8.77773 14.237C8.11993 13.8039 7.60724 13.1883 7.30449 12.4681C7.00174 11.7478 6.92253 10.9553 7.07687 10.1907C7.23121 9.42608 7.61217 8.72374 8.17158 8.17249C8.73099 7.62124 9.44373 7.24583 10.2197 7.09374C10.9956 6.94165 11.7998 7.01971 12.5307 7.31804C13.2616 7.61638 13.8864 8.12159 14.3259 8.76979C14.7654 9.418 15 10.1801 15 10.9597C14.9987 12.0047 14.5768 13.0065 13.827 13.7454C13.0771 14.4843 12.0605 14.9 11 14.9013Z" fill="black"/></svg>
						<div class="ml-9 w-52">
							<div class="font-['Poppins'] text-2xl font-medium text-[#000000]">Address</div>	
							<div class="font-['Poppins'] text-base font-normal text-[#000000]">236 5th SE Avenue, New York NY10000, United States</div>
						</div>
					</div>

					<!-- info item -->
					<div class="w-80 flex mb-10">
						<svg class="w-8" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div class="ml-9 w-52">
							<div class="font-['Poppins'] text-2xl font-medium text-[#000000]">Phone</div>	
							<div class="font-['Poppins'] text-base font-normal text-[#000000]">
					...
					<!-- info item -->
					<div class="w-80 flex">
						<svg class="w-8" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div class="ml-9 w-52">
							<div class="font-['Poppins'] text-2xl font-medium text-[#000000]">Working Time</div>	
							<div class="font-['Poppins'] text-base font-normal text-[#000000]">
				...
				<!-- Contact form  -->
				<div class="flex flex-col w-full ml-12 mr-12 items-end">
					{#if !contactSubmited}
						<form class="shrink w-full max-w-lg items-end" method="post" on:submit|preventDefault={formContact}>
							<label for="name" class="font-['Poppins'] text-base font-medium text-[#000000]">Your name</label>
							...
							<label for="Subject" class="font-['Poppins'] text-base font-medium text-[#000000]">Subject</label>
							<input bind:value={inputSubject} name="Subject" id="Subject" type="text" placeholder="This is an optional" 
							class="mt-5 mb-9 w-full h-16 p-2 rounded outline-none border-[1px] border-slate-400 focus-visible:border-black ">

							<label for="Message" class="font-['Poppins'] text-base font-medium text-[#000000]">Message</label>
							<textarea bind:value={inputMessage} name="Message" id="Message"  placeholder="Hi! i’d like to ask about" 
							...
							<button type="submit" class="w-60 rounded text-white mt-5 p-3 bg-[#B88E2F] hover:bg-[#d9b051]">Submit</button>
						</form>
					{:else}
